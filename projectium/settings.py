"""
Django settings for projectium project.
...
SECRET_KEY = 'uhk-xnzop^&^m&1bztnx&tbm+=ao*6g!t3ouw77o$4+qo!@=&y'
...
ROOT_URLCONF = 'projectium.urls'

WSGI_APPLICATION = 'projectium.wsgi.application'
...
DATABASES['default']['NAME'] = 'projectium'
